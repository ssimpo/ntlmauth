...
var NTLMAuth = (function(config) { 
	...
	NTLMAuth.prototype.createSSPIRequest = function(domainName, clientName) {
		...
		ntlmPacket.writeInt32LE(0x0008B205, 12);
		...
		// Offset
		ntlmPacket.writeInt32LE(32, 20);
	
		// Client Name Length and Position
		// Allocated
		ntlmPacket.writeInt16LE(0, 24);
		// Used
		ntlmPacket.writeInt16LE(0, 26);
		// Offset
		ntlmPacket.writeInt32LE(32, 28);
